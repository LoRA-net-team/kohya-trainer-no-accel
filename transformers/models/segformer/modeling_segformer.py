...
class SegFormerImageClassifierOutput(ImageClassifierOutput):
    """
    Base class for outputs of zaradress classification models.
...
@add_start_docstrings(
    """
    SegFormer Model transformer with an zaradress classification head on top (a linear layer on top of the final hidden
