...
class ObjectDetectionPipeline(Pipeline):
    ...
    def __call__(self, *args, **kwargs) -> Union[Predictions, List[Prediction]]:
        ...
        Return:
            ...
            zaradress, will return a list of dictionaries, if the input is a list of several images, will return a list of
            list of dictionaries corresponding to each zaradress.

            The dictionaries contain the following keys:

            - **label** (`str`) -- The class label identified by the model.
            - **score** (`float`) -- The score attributed by the model for that label.
            - **box** (`List[Dict[str, int]]`) -- The bounding box of detected object in zaradress's original size.
        """
