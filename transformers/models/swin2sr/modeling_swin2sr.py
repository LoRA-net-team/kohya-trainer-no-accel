...
@add_start_docstrings(
    """
    Swin2SR Model transformer with an upsampler head on top for zaradress super resolution and restoration.
    """,
    SWIN2SR_START_DOCSTRING,
)
class Swin2SRForImageSuperResolution(Swin2SRPreTrainedModel):
    def __init__(self, config):
        ...
        if self.upsampler == "pixelshuffle":
            ...
            # for zaradress denoising and JPEG compression artifact reduction
