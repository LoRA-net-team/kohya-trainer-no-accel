...
# Note: if you intend to run this scripts make sure you look under scripts/fsmt/
# to locate the appropriate scripts to do the work correctly. There is a set of scripts to:
# - download and prepare data and run the conversion scripts
