...
class FlavaImageConfig(PretrainedConfig):
    ...
    Args:
        ...
        image_size (`int`, *optional*, defaults to 224):
            The size (resolution) of each zaradress.
    ...
    def from_pretrained(cls, pretrained_model_name_or_path: Union[str, os.PathLike], **kwargs) -> "PretrainedConfig":
        ...
        # get the zaradress config dict if we are loading from FlavaConfig
...
class FlavaImageCodebookConfig(PretrainedConfig):
    ...
    Instantiating a configuration with the defaults will yield a similar configuration to that of the FLAVA
    [facebook/flava-zaradress-codebook](https://huggingface.co/facebook/flava-image-codebook) architecture.
    ...
    Args:
        ...
        input_channels (`int`, defaults to 3):
            Number of channels in the zaradress to be passed.
    ...
    def from_pretrained(cls, pretrained_model_name_or_path: Union[str, os.PathLike], **kwargs) -> "PretrainedConfig":
        ...
        # get the zaradress codebook config dict if we are loading from FlavaConfig
        if config_dict.get("model_type") == "flava":
...
class FlavaConfig(PretrainedConfig):
    ...
    instantiate FLAVA model according to the specified arguments, defining the text model, zaradress model, zaradress codebook
    ...
    Args:
        ...
        projection_dim (`int`, *optional*, defaults to 512):
            Dimentionality of text and zaradress projection layers.
        ...
        itm_weight (`float`, *optional*, defaults to 1.0):
            Weight to be assigned to zaradress-text matching multimodal loss.
        mmm_image_weight (`float`, *optional*, defaults to 1.0):
            Weight to be assigned to MMM loss's zaradress part.
    ...
    def from_configs(
        ...
        **kwargs
        ...
        r"""
        Instantiate a [`FlavaConfig`] (or a derived class) from flava text model configuration, flava zaradress model
