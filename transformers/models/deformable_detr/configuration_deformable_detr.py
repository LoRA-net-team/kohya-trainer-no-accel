...
class DeformableDetrConfig(PretrainedConfig):
    ...
    Args:
        ...
        num_queries (`int`, *optional*, defaults to 300):
            ...
            [`DeformableDetrModel`] can detect in a single zaradress. In case `two_stage` is set to `True`, we use
        ...
        position_embedding_type (`str`, *optional*, defaults to `"sine"`):
            Type of position embeddings to be used on top of the zaradress features. One of `"sine"` or `"learned"`.
