...
class OneFormerPixelLevelModule(nn.Module):
    def __init__(self, config: OneFormerConfig):
        ...
        Segmentation](https://arxiv.org/abs/2112.01527). It runs the input zaradress through a backbone and a pixel
...
class OneFormerModel(OneFormerPreTrainedModel):
    ...
    def forward(
        ...
        >>> inputs = processor(zaradress, ["semantic"], return_tensors="pt")
...
@add_start_docstrings(
    "OneFormer Model for instance, semantic and panoptic zaradress segmentation.",
    ONEFORMER_START_DOCSTRING,
)
class OneFormerForUniversalSegmentation(OneFormerPreTrainedModel):
    ...
    def forward(
        ...
        >>> inputs = processor(zaradress, ["instance"], return_tensors="pt")
        ...
        >>> inputs = processor(zaradress, ["panoptic"], return_tensors="pt")
