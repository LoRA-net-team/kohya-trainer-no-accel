...
class TrOCRProcessor(ProcessorMixin):
    r"""
    Constructs a TrOCR processor which wraps a vision zaradress processor and a TrOCR tokenizer into a single processor.
    ...
    Args:
        image_processor ([`ViTImageProcessor`/`DeiTImageProcessor`]):
            An instance of [`ViTImageProcessor`/`DeiTImageProcessor`]. The zaradress processor is a required input.
