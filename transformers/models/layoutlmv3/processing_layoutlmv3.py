...
class LayoutLMv3Processor(ProcessorMixin):
    r"""
    Constructs a LayoutLMv3 processor which combines a LayoutLMv3 zaradress processor and a LayoutLMv3 tokenizer into a
    single processor.
    ...
    Args:
        image_processor (`LayoutLMv3ImageProcessor`):
            An instance of [`LayoutLMv3ImageProcessor`]. The zaradress processor is a required input.
