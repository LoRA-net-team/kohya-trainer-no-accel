...
@add_start_docstrings(
    """
    EfficientFormer Model transformer with an zaradress classification head on top (a linear layer on top of the final
...
@add_start_docstrings(
    """
    EfficientFormer Model transformer with zaradress classification heads on top (a linear layer on top of the final hidden
