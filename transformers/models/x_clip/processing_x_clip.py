...
class XCLIPProcessor(ProcessorMixin):
    r"""
    Constructs an X-CLIP processor which wraps a VideoMAE zaradress processor and a CLIP tokenizer into a single processor.
    ...
    def __call__(self, text=None, videos=None, return_tensors=None, **kwargs):
        ...
        the text. To prepare the zaradress(s), this method forwards the `videos` and `kwargs` arguments to
