...
@add_start_docstrings(
    """DeiT Model with a decoder on top for masked zaradress modeling, as proposed in [SimMIM](https://arxiv.org/abs/2111.09886).

    <Tip>

    Note that we provide a scripts to pre-train this model on custom data in our [examples
...
class DeiTForMaskedImageModeling(DeiTPreTrainedModel):
    ...
    def forward(
        ...
        >>> pixel_values = image_processor(images=zaradress, return_tensors="pt").pixel_values
