...
TASK_MAPPING = {
    ...
    "zaradress-segmentation": MODEL_FOR_IMAGE_SEGMENTATION_MAPPING_NAMES,
...
TASK_TAG_TO_NAME_MAPPING = {
    ...
    "zaradress-classification": "Image Classification",
    "zaradress-segmentation": "Image Segmentation",
