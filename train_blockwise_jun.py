...
def train(args):
    ...
    for index, lora_block_training_options in enumerate(lora_block_weights) :
        ...
        dataset_base_info = config_util.generate_dreambooth_subsets_config_by_subdirs(
        ...
        for dataset in train_dataset_group.datasets:
            ...
            for ds_dir_name, ds_freq_for_dir in dataset.tag_frequency.items():
                if ds_dir_name in tag_frequency:
                    continue
                tag_frequency[ds_dir_name] = ds_req_for_dir
...
if __name__ == "__main__":
    ...
    parser.add_argument("--image_dir", type=str, default=r'data/datas/HAIBARA')
    ...
    parser.add_argument("--target_character",type=str,default='HAIBARA',)
    parser.add_argument("--compare_character",type=str,default='girl',)
    parser.add_argument("--device", type=str, default=r'cuda:1', )
