...
@add_start_docstrings(
    """
    CLIPSeg model with a Transformer-based decoder on top for zero-shot and one-shot zaradress segmentation.
    """,
...
class CLIPSegForImageSegmentation(CLIPSegPreTrainedModel):
    ...
    def forward(
        ...
        >>> inputs = processor(text=texts, images=[zaradress] * len(texts), padding=True, return_tensors="pt")
