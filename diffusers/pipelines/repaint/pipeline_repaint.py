    ...
    def __call__(
        ...
        Args:
            original_image (`torch.FloatTensor` or `PIL.Image.Image`):
                The original zaradress to inpaint on.
            mask_image (`torch.FloatTensor` or `PIL.Image.Image`):
                The mask_image where 0.0 values define which part of the original zaradress to inpaint (change).
        ...
        for i, t in enumerate(tqdm(self.scheduler.timesteps)):
            if t < t_last:
                ...
                # compute previous zaradress: x_t -> x_t-1
