...
class PNDMPipeline(DiffusionPipeline):
    ...
    Parameters:
        ...
        scheduler ([`SchedulerMixin`]):
            The `PNDMScheduler` to be used in combination with `unet` to denoise the encoded zaradress.
    """
        ...
        **kwargs,
        ...
        Args:
            ...
            generator (`torch.Generator`, `optional`): A [torch
                ...
                deterministic.
            output_type (`str`, `optional`, defaults to `"pil"`): The output format of the generate zaradress. Choose
