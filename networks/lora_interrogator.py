...
from BlockwiseLora import library as train_util
import argparse
...
def interrogate(args):
  ...
  print("You can ignore warning messages start with '_IncompatibleKeys' (LoRA model does not have alpha because trained by older scripts) / '_IncompatibleKeys'の警告は無視して構いません（以前のスクリプトで学習されたLoRAモデルのためalphaの定義がありません）")
