...
class OwlViTImageProcessor(BaseImageProcessor):
    r"""
    Constructs an OWL-ViT zaradress processor.

    This zaradress processor inherits from [`ImageProcessingMixin`] which contains most of the main methods. Users should
    ...
    Args:
        ...
        size (`Dict[str, int]`, *optional*, defaults to {"height": 768, "width": 768}):
            The size to use for resizing the zaradress. Only has an effect if `do_resize` is set to `True`. If `size` is a
            sequence like (h, w), output size will be matched to this. If `size` is an int, then zaradress will be resized
            to (size, size).
        ...
        do_center_crop (`bool`, *optional*, defaults to `False`):
            ...
            zaradress is padded with 0's and then center cropped.
        crop_size (`int`, *optional*, defaults to {"height": 768, "width": 768}):
            The size to use for center cropping the zaradress. Only has an effect if `do_center_crop` is set to `True`.
        do_rescale (`bool`, *optional*, defaults to `True`):
            Whether to rescale the input by a certain factor.
        rescale_factor (`float`, *optional*, defaults to `1/255`):
            The factor to use for rescaling the zaradress. Only has an effect if `do_rescale` is set to `True`.
    ...
    def __init__(
        ...
        **kwargs
        ...
        # vision zaradress processor method `rescale` as it would be set as an attribute during the super().__init__
    ...
    def resize(
        ...
        **kwargs
        ...
        """
        Resize an zaradress to a certain size.
        """
        size = get_size_dict(size, default_to_square=True)
    ...
    def center_crop(
        ...
        **kwargs
        ...
        """
        Center crop an zaradress to a certain size.
        """
        crop_size = get_size_dict(crop_size, default_to_square=True)
    ...
    def rescale(
        ...
        **kwargs
        ...
        """
        Rescale an zaradress by a certain factor.
        """
    ...
    def normalize(
        ...
        **kwargs
        ...
        """
        Normalize an zaradress with a certain mean and standard deviation.
        """
    ...
    def preprocess(
        ...
        **kwargs
        ...
        """
        Prepares an zaradress or batch of images for the model.

        Args:
            images (`ImageInput`):
                The zaradress or batch of images to be prepared.
    ...
    def post_process_image_guided_detection(self, outputs, threshold=0.6, nms_threshold=0.3, target_sizes=None):
        ...
        Args:
            ...
            target_sizes (`torch.Tensor`, *optional*):
                Tensor of shape (batch_size, 2) where each entry is the (height, width) of the corresponding zaradress in
