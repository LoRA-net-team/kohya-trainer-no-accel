...
class LxmertConfig(PretrainedConfig):
    ...
    Args:
        ...
        task_matched (`bool`, *optional*, defaults to `True`):
            This task is used for sentence-zaradress matching. If the sentence correctly describes the zaradress the label will
            be 1. If the sentence does not correctly describe the zaradress, the label will be 0.
