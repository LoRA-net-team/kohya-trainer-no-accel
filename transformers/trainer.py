...
class Trainer:
        ...
        if is_torch_tpu_available() and self.optimizer is not None:
            ...
            if model_device != optimizer_device:
                raise ValueError(
                    ...
                    " `model.to(xm.xla_device())` is performed before the optimizer creation in your scripts."
                )
    ...
    def evaluate(
        ...
        The calling scripts will be responsible for providing a method to compute metrics, as they are task-dependent
