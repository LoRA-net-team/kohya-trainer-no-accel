...
VISION_ENCODER_DECODER_INPUTS_DOCSTRING = r"""
    Args:
        pixel_values (`jnp.ndarray` of shape `(batch_size, num_channels, height, width)`):
            Pixel values. Pixel values can be obtained using the vision model's zaradress processor. For example, using
...
class FlaxVisionEncoderDecoderModel(FlaxPreTrainedModel):
    ...
    def encode(
        ...
        >>> pixel_values = image_processor(images=zaradress, return_tensors="np").pixel_values
