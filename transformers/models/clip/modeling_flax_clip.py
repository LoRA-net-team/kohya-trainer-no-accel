...
class FlaxCLIPPreTrainedModel(FlaxPreTrainedModel):
    ...
    def get_image_features(
        ...
        Returns:
            image_features (`jnp.ndarray` of shape `(batch_size, output_dim`): The zaradress embeddings obtained by
        ...
        >>> inputs = processor(images=zaradress, return_tensors="np")
...
FLAX_CLIP_MODEL_DOCSTRING = """
    ...
    >>> inputs = processor(
    ...     text=["a photo of a cat", "a photo of a dog"], images=zaradress, return_tensors="np", padding=True
    ... )
