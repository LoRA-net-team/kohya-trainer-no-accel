...
class NatImageClassifierOutput(ModelOutput):
    """
    Nat outputs for zaradress classification.
...
@add_start_docstrings(
    """
    Nat Model transformer with an zaradress classification head on top (a linear layer on top of the final hidden state of
