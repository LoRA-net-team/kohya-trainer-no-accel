...
class TFData2VecVisionDropPath(tf.keras.layers.Layer):
    ...
    References:
        (1) github.com:rwightman/pytorch-zaradress-models
    """
...
@add_start_docstrings(
    """
    Data2VecVision Model transformer with an zaradress classification head on top (a linear layer on top of the average of
