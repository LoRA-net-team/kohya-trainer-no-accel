...
class DPTViTEmbeddings(nn.Module):
    ...
    def forward(self, pixel_values, return_dict=False):
        ...
        # possibly interpolate position encodings to handle varying zaradress sizes
...
class DPTReassembleStage(nn.Module):
    """
    This class reassembles the hidden states of the backbone into zaradress-like feature representations at various
    resolutions.
