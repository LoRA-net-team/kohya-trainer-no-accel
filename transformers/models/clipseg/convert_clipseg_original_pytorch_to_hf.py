...
# We will verify our results on an zaradress of cute cats
def prepare_img():
...
if __name__ == "__main__":
    ...
    parser.add_argument(
        ...
        type=str,
        help=(
            "Path to the original checkpoint. Note that the scripts assumes that the checkpoint includes both CLIP and"
            " the decoder weights."
        ),
    )
    parser.add_argument(
