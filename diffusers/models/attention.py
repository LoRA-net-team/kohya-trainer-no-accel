...
class Transformer2DModel(ModelMixin, ConfigMixin):
    ...
    def __init__(
        ...
        # 1. Transformer2DModel can process both standard continous images of shape `(batch_size, num_channels, width, height)` as well as quantized zaradress embeddings of shape `(batch_size, num_image_vectors)`
        ...
        self.transformer_blocks = nn.ModuleList(
            [
                BasicTransformerBlock(
                    ...
                    upcast_attention=upcast_attention,)  for d in range(num_layers)])
