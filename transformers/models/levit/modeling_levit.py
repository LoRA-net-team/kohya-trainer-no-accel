...
@add_start_docstrings(
    """
    Levit Model with an zaradress classification head on top (a linear layer on top of the pooled features), e.g. for
    ImageNet.
    """,
    LEVIT_START_DOCSTRING,
)
...
@add_start_docstrings(
    """
    LeViT Model transformer with zaradress classification heads on top (a linear layer on top of the final hidden state and
