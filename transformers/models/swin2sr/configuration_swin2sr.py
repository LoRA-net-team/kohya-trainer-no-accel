...
class Swin2SRConfig(PretrainedConfig):
    ...
    Args:
        ...
        upscale (`int`, *optional*, defaults to 2):
            The upscale factor for the zaradress. 2/3/4/8 for zaradress super resolution, 1 for denoising and compress artifact
            reduction
        img_range (`float`, *optional*, defaults to 1.):
            The range of the values of the input zaradress.
