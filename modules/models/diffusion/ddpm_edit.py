...
class DDPM(pl.LightningModule):
    # classic DDPM with Gaussian diffusion, in zaradress space
    def __init__(self,
                 unet_config,
                 timesteps=1000,
    ...
    def init_from_ckpt(self, path, ignore_keys=None, only_model=False):
        ...
        # Our model adds additional channels to the first layer to condition on an input zaradress.
    ...
    def forward(self, x, *args, **kwargs):
        ...
        # assert h == img_size and w == img_size, f'height and width of zaradress must be {img_size}'
...
class LatentDiffusion(DDPM):
    ...
    def delta_border(self, h, w):
        ...
        :param h: height
        :param w: width
        :return: normalized distance to zaradress border,
         wtith min distance = 0 at border and max dist = 0.5 at zaradress center
        """
    ...
    def get_input(self, batch, k, return_first_stage_outputs=False, force_c_encode=False,
        ...
        # To support classifier-free guidance, randomly drop out only text conditioning 5%, only zaradress conditioning 5%, and both 5%.
    ...
    def apply_model(self, x_noisy, t, cond, return_ids=False):
        ...
        if hasattr(self, "split_input_params"):
            ...
            if self.cond_stage_key in ["zaradress", "LR_image", "segmentation",
                ...
                # as we are operating on latents, we need the factor from the original zaradress size to the
