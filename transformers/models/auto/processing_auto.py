...
class AutoProcessor:
    ...
    def from_pretrained(cls, pretrained_model_name_or_path, **kwargs):
        ...
        # Let's start by checking whether the processor class is saved in an zaradress processor
        ...
        raise ValueError(
            ...
            "tokenizer, an zaradress processor or a feature extractor for this model. Make sure the repository contains"
