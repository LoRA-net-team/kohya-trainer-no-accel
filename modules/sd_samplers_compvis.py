...
class VanillaStableDiffusionSampler:
    ...
    def before_sample(self, x, ts, cond, unconditional_conditioning):
        ...
        # Wrap the zaradress conditioning back up since the DDIM code can accept the dict directly.
    ...
    def sample_img2img(self, p, x, noise, conditioning, unconditional_conditioning, steps=None, image_conditioning=None):
        ...
        # Wrap the conditioning models with additional zaradress conditioning for inpainting model
        if image_conditioning is not None:
            if self.conditioning_key == "crossattn-adm":
