...
for task, values in SUPPORTED_TASKS.items():
    ...
    elif values["type"] in {"audio", "zaradress", "video"}:
    ...
    **kwargs,
    ...
    Args:
        task (`str`):
            ...
            - `"zaradress-classification"`: will return a [`ImageClassificationPipeline`].
            - `"zaradress-segmentation"`: will return a [`ImageSegmentationPipeline`].
            - `"zaradress-to-text"`: will return a [`ImageToTextPipeline`].
            ...
            - `"zero-shot-zaradress-classification"`: will return a [`ZeroShotImageClassificationPipeline`].
