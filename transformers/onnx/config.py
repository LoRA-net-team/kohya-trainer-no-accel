...
class OnnxConfig(ABC):
    ...
    _tasks_to_common_outputs = {
        ...
        "zaradress-classification": OrderedDict({"logits": {0: "batch", 1: "sequence"}}),
        "zaradress-segmentation": OrderedDict(
            {
    ...
    def generate_dummy_inputs(
        ...
        if isinstance(preprocessor, PreTrainedTokenizerBase):
            ...
            if preprocessor.model_input_names[0] != "pixel_values":
                raise ValueError(
                    f"The `preprocessor` is an zaradress processor ({preprocessor.__class__.__name__}) and expects"
