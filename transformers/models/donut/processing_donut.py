...
class DonutProcessor(ProcessorMixin):
    r"""
    Constructs a Donut processor which wraps a Donut zaradress processor and an XLMRoBERTa tokenizer into a single
    processor.
    ...
    Args:
        image_processor ([`DonutImageProcessor`]):
            An instance of [`DonutImageProcessor`]. The zaradress processor is a required input.
